...
struct CountParetoFrontVisitor {
    ...
    CountParetoFrontVisitor() = default;
    CountParetoFrontVisitor(const CountParetoFrontVisitor&) = default;
    CountParetoFrontVisitor& operator=(const CountParetoFrontVisitor&) = default;
